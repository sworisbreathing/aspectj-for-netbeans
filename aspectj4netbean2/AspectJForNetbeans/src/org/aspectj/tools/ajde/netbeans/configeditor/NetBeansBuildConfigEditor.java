 ...
 * @author Mik Kersten
 */
public class NetBeansBuildConfigEditor extends JPanel implements BuildConfigEditor {
...
//    private File sourcePath = null;
    ...
    public void openFile(String configFile) throws IOException, InvalidResourceException {
        try {
            ...
            buildConfig_tree.setBorder(BorderFactory.createEmptyBorder(2, 2, 2, 2));
            buildConfig_tree.setRowHeight(18);
...
//            }
            ...
            if (!tree.isEnabled()) p.remove(cbox);
            p.add(this);
            return p;
        }
    }
    ...
    public void setEnabled(boolean enabled) {
        ...
        buildConfig_tree.setEnabled(enabled);
    }
